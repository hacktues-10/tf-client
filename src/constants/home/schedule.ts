export const SCHEDULE_DAY1 = [
	...
	},
	{
		...
		description: `<ul class='flex flex-col gap-2 pt-2'>
			...
			<li class='px-4 py-2 bg-bg-color border border-stroke rounded-xl'>The best application defense is a proactive offense</li>
...
export const LECTORS = [
	...
	},
	{
		...
		lecture: 'The best application defense is a proactive offense',
	},
	{
		name: 'Иво Емануилов',
