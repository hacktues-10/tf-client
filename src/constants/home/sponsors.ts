...
import capitalLogo from '@/media/capital.png';
import devstylerArticleLogo from '@/media/devstyler.png';
import investorLogo from '@/media/investor.png';
...
const BETA_SPONSORS = [
	{
		...
		supportedEditions: ['hacktues-security', 'hacktues-infinity', 'hacktues-gg', 'hacktues-3', 'hacktues-2'],
		description:
	...
	},
	{
		...
		description:
			`Подкрепяме TUES FEST от години, защото наша мисия е инвестицията в ИТ образованието и бъдещето на сектора. Изложението е чудесен начин учениците да представят училището си пред бъдещите туесари чрез своите проекти, които са разработвали през годината.
