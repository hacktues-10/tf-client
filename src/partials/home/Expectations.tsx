...
const Expectation = ({ icon, title, text }: { icon: JSX.Element; title: string; text: string }) => (
	<div className=" w-full md:w-2/5 lg:w-1/3 2xl:w-1/4">
		<div className="h-full group mb-10 rounded-xl border border-[#FEFEFE] p-7 backdrop-filter backdrop-blur-sm sm:backdrop-blur-md bg-opacity-0 hover:scale-105 transition-all duration-300">
